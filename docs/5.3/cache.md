...
To execute code on every cache operation, you may listen for the [events](/laravel_tw/docs/5.3/events) fired by the cache. Typically, you should place these event listeners within your `EventServiceProvider`:
