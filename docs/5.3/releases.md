...
Laravel 5.3 makes API authentication a breeze using [Laravel Passport](/laravel_tw/docs/5.3/passport), which provides a full OAuth2 server implementation for your Laravel application in a matter of minutes. Passport is built on top of the [League OAuth2 server](https://github.com/thephpleague/oauth2-server) that is maintained by Alex Bilbie.
...
For more information on storing uploaded files, check out the [full documentation](/laravel_tw/docs/5.3/filesystem#file-uploads).
...
For more information on writing global scopes, check out the full [Eloquent documentation](/laravel_tw/docs/5.3/eloquent#global-scopes).

<a name="laravel-5.1.11"></a>
## Laravel 5.1.11

Laravel 5.1.11 introduces [authorization](/laravel_tw/docs/5.3/authorization) support out of the box! Conveniently organize your application's authorization logic using simple callbacks or policy classes, and authorize actions using simple, expressive methods.

For more information, please refer to the [authorization documentation](/laravel_tw/docs/5.3/authorization).

<a name="laravel-5.1.4"></a>
## Laravel 5.1.4

Laravel 5.1.4 introduces simple login throttling to the framework. Consult the [authentication documentation](/laravel_tw/docs/5.3/authentication#authentication-throttling) for more information.
...
To learn more about event broadcasting, check out the [event documentation](/laravel_tw/docs/5.3/events#broadcasting-events).
...
For more information on middleware, check out the [middleware documentation](/laravel_tw/docs/5.3/middleware).
...
For more information on testing, check out the [testing documentation](/laravel_tw/docs/5.3/testing).

### Model Factories

Laravel now ships with an easy way to create stub Eloquent models using [model factories](/laravel_tw/docs/5.3/database-testing#writing-factories). Model factories allow you to easily define a set of "default" attributes for your Eloquent model, and then generate test model instances for your tests or database seeds. Model factories also take advantage of the powerful [Faker](https://github.com/fzaninotto/Faker) PHP library for generating random attribute data:
...
For more information on model factories, check out [the documentation](/laravel_tw/docs/5.3/database-testing#writing-factories).
...
For more information on defining Artisan commands, consult the [Artisan documentation](/laravel_tw/docs/5.3/artisan).
...
For more information on contracts, consult the [full documentation](/laravel_tw/docs/5.3/contracts).
...
For more information on middleware, check out [the documentation](/laravel_tw/docs/5.3/middleware).

### Controller Method Injection

In addition to the existing constructor injection, you may now type-hint dependencies on controller methods. The [service container](/laravel_tw/docs/5.3/container) will automatically inject the dependencies, even if the route contains other parameters:
...
For more information on working with events, check out the [full documentation](/laravel_tw/docs/5.3/events).
...
Of course, you may also use commands for tasks that are executed synchronously (are not queued). In fact, using commands is a great way to encapsulate complex tasks your application needs to perform. For more information, check out the [command bus](/laravel_tw/docs/5.3/bus) documentation.
...
Of course, check out the [full documentation](/laravel_tw/docs/5.3/scheduling) to learn all about the scheduler!
...
For more information on Elixir, check out the [full documentation](/laravel_tw/docs/5.3/elixir).
...
No more spending hours writing OAuth authentication flows. Get started in minutes! The [full documentation](/laravel_tw/docs/5.3/authentication#social-authentication) has all the details.
...
For more information on the Laravel Flysystem integration, consult the [full documentation](/laravel_tw/docs/5.3/filesystem).
...
For more information on this new method, check out [the documentation](/laravel_tw/docs/5.3/validation#validation-quickstart).
