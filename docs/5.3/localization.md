...
Of course if you are using the [Blade templating engine](/laravel_tw/docs/5.3/blade), you may use the `{% raw %} {{ }} {% endraw %}` syntax to echo the language line or use the `@lang` directive:
