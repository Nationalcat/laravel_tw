...
Of course if you are using the [Blade templating engine](/laravel_tw/docs/5.4/blade), you may use the `{% raw %} {{ }} {% endraw %}` syntax to echo the translation string or use the `@lang` directive:
