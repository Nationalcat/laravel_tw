...
After generating the versioned file, you may use Laravel's global `elixir` helper within your [views](/laravel_tw/docs/master/views) to load the appropriately hashed asset. The `elixir` function will automatically determine the current name of the hashed file:
