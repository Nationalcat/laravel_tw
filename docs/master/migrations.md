...
The Laravel `Schema` [facade](/laravel_tw/docs/master/facades) provides database agnostic support for creating and manipulating tables across all of Laravel's supported database systems.

<a name="generating-migrations"></a>
## Generating Migrations

To create a migration, use the `make:migration` [Artisan command](/laravel_tw/docs/master/artisan):
...
> {note} If you are using the [Homestead virtual machine](/laravel_tw/docs/master/homestead), you should run this command from within your virtual machine.
